<div x-data="{ open: false }" class="bg-blue-800 shadow-md">
      ...
      <aside class="hidden sm:flex">
          <div class="flex flex-col h-full items-center">
            ...
            <nav class="mt-4">
              ...
              @endif
              <div class="mt-8 border border-white"></div>
              <li class="mt-4">
                <a href="/logout" class="block rounded-md px-4 py-2 text-base font-medium text-white hover:bg-gray-700 hover:text-white">Sign out</a>
              </li>
              </ul>
            </nav>
          </div>
